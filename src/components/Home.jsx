                                ...
                                blurDelay = gsap.delayedCall(
                                    ...
                                    () => {
                                        ...
                                        blurTween = gsap.to(icons, {
                                            ...
                                            opacity: 1,
                                            duration:
                                                iconAnimationSettings.blur.duration,
                                            ease: iconAnimationSettings.blur.ease,
                                        })
                                    },
                                )
    ...
    return (
        <main className="bg-white">
            <div className="mx-auto flex w-full max-w-[1300px] flex-col items-center">
                <section className="w-full px-6 pb-12 pt-20 text-center sm:pt-24">
                    <p className="text-lg font-medium text-[var(--color-primary)]">
                        Frontend Developer
                    </p>
                    <h1 className="mt-3 text-6xl font-semibold tracking-normal text-[#171717] sm:text-7xl">
                        JOYEYEON
                    </h1>
                </section>

                <div className="w-full">
                    <TabletZoomHero nextSectionId="home-after-portfolio">
                        {/* <Portpolio1 /> */}
                        <Portpolio2 />
                    </TabletZoomHero>
                </div>
                    ...
                    >
                        {toolIcons.map((icon, index) => (
                            ...
                            >
                                <button
                                    type="button"
                                    className={`h-full w-full border-0 bg-transparent p-0 transition-transform duration-200 ease-out ${isIconModalEnabled
                                ...
                                >
                                    <img
                                        src={icon.src}
                                        alt={icon.alt}
                                        className={`h-full w-full object-contain ${isIconJiggleActive
                                            ? 'icon-jiggle'
                                            : ''
                                            }`}
                                        style={{
                        ...
                        >
                            {textSequences.map((sequence, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <p
                                            className={`w-max whitespace-nowrap text-center text-[clamp(2.25rem,9vw,8rem)] font-black leading-[0.9] tracking-[-0.065em] text-[var(--color-primary)] will-change-transform ${isTextAnimationActive
